...
## [7.2.1](https://github.com/taikoxyz/revm/compare/revm-v7.2.0...revm-v7.2.1) - 2024-03-27

### Fixed
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/taikoxyz/revm/pull/1216))

### Other
- *(interpreter)* unbox contract field ([#1228](https://github.com/taikoxyz/revm/pull/1228))
- *(primitives)* kzg intro ([#1209](https://github.com/taikoxyz/revm/pull/1209))
- *(interpreter)* keep track of remaining gas rather than spent ([#1221](https://github.com/taikoxyz/revm/pull/1221))
- Improve `EthersDB` ([#1208](https://github.com/taikoxyz/revm/pull/1208))
