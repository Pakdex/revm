...
## [4.0.0](https://github.com/taikoxyz/revm/compare/revm-interpreter-v3.4.0...revm-interpreter-v4.0.0) - 2024-03-27

### Added
- *(interpreter)* expose mutable access methods on stack and memory ([#1219](https://github.com/taikoxyz/revm/pull/1219))
...
- *(interpreter)* don't run signextend with 31 too ([#1222](https://github.com/taikoxyz/revm/pull/1222))
